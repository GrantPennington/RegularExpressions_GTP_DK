...
public class ProcessSchedule {
    ...
    public static void GetCourseInfo() throws IOException {
        ...
        try (Stream<String> lines = Files.lines(Paths.get("../Bellarmine_Schedule.txt"))) { // read all lines from Bellarmine_Schedule.txt
    ...
    public static void GetCourseStatus() throws IOException {
        ...
        try (Stream<String> lines = Files.lines(Paths.get("../courseInfo.txt"))) { // read all lines from the courseInfo.txt generated from the GetClassInfo() method
            
            // File and FileWriter classes
            File status = new File("../courseStatus.txt");
